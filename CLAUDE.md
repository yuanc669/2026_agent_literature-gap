...
## 對話開始時請先讀
進度與最近更動都在 Obsidian：`literature-gap/2026_agent_literature-gap/工作筆記.md`
...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`G:\我的雲端硬碟\2026_agent_literature-gap\`（自動跨電腦同步）
- 🐙 GitHub repo：`yuanc669/2026_agent_literature-gap`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`literature-gap/2026_agent_literature-gap/工作筆記.md`（想法的家）
